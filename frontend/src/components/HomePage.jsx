...
const LogoSlider = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-background py-10" style={{ width: '90vw', marginLeft: '-5vw' }}>
  ...
  return (
    <div>
      <div className="text-center space-y-24">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between">
            <div className="text-left max-w-2xl">
              <h1 style={{ fontSize: '58px' }} className="text-5xl font-extrabold text-primary sm:text-6xl md:text-7xl leading-tight">
                The World's First All-in-One Ethereum Monitoring Solution.
              </h1>

              <p style={{ fontSize: '28px' }} className="mt-6 text-xl text-primary/80 sm:text-2xl md:text-3xl leading-relaxed">
            ...
            <div style={{ marginTop: '-40px', height: '460px', marginLeft: '30px' }} className="w-[500px] h-[500px]">
              <DotLottieReact
        ...
        <div style={{ borderRadius: '20px', position: 'relative', width: '89vw' }}>
          <img 
            style={{ 
              borderRadius: '20px',
              position: 'absolute',
          ...
          >
            <div className="max-w-4xl mx-auto">
              <h2 style={{ fontSize: '40px' }} className="text-3xl font-bold text-primary sm:text-4xl md:text-5xl leading-tight">
        ...
        <div className="max-w-6xl mx-auto px-4 space-y-8">
          <div className="flex items-center justify-between p-8 border border-primary/10 rounded-xl">
            <div className="w-1/2 pr-8">
              <h3 className="text-2xl font-bold text-primary mb-4">Wallet Tracking</h3>
          ...
          <div className="flex items-center justify-between p-8 border border-primary/10 rounded-xl">
            ...
            <div className="w-1/2 pl-8">
              <h3 className="text-2xl font-bold text-primary mb-4">Identify Short-Term Whales</h3>
              <p className="text-lg text-primary/70">
          ...
          <div className="flex items-center justify-between p-8 border border-primary/10 rounded-xl">
            <div className="w-1/2 pr-8">
              <h3 className="text-2xl font-bold text-primary mb-4">View Wallet Portfolio</h3>
              <p className="text-lg text-primary/70">
